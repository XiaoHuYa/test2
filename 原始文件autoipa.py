...
# 项目根目录
project_path = "/Users/dsy/Documents/vlinkercode/vlife-混合/platforms/ios"
# 编译成功后.app所在目录
app_path = "/Users/dsy/Documents/vlinkercode/vlife-混合/platforms/ios/build/Build/Products/Release-iphoneos/vlife.app"
# 指定项目下编译目录
build_path = "build"
# 打包后ipa存储目录
targerIPA_parth = "/Users/dsy/Desktop"
...
def build_project():
    ...
    os.system ('cd %s;xcodebuild -workspace vlife.xcworkspace  -scheme vlife -configuration release -derivedDataPath %s ONLY_ACTIVE_ARCH=NO || exit' % (project_path,build_path))
